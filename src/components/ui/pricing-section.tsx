        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4 lg:gap-3">
          ...
          >
            ...
            <a
              ...
              className="w-full py-2 px-4 rounded-md text-sm font-semibold text-center transition-all duration-300 inline-flex items-center justify-center bg-white/5 border border-white/20 text-white hover:bg-white/10 hover:border-white/30"
            >
              ...
              <div className="space-y-4">
                ...
                <div className="pt-2">
                  <a
                    ...
                    className="inline-flex items-center justify-center py-2 px-6 rounded-md font-semibold transition-all duration-300 bg-[#34C759] text-black hover:bg-[#2db84d] shadow-lg shadow-[#34C759]/25"
                  >
                    Contact Our Team
                  </a>
                </div>
