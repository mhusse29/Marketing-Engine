...
export type HeroScrollVideoProps = {
  // Top headline area
  lamp?: ReactNode; // Optional lamp animation above title
  title?: ReactNode;
  subtitle?: ReactNode;
...
export const HeroScrollVideo: React.FC<HeroScrollVideoProps> = ({
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      const stickyEl = triggerEl.querySelector(".hsv-sticky");
      ...
      gsap.set(overlayEl, { 
        ...
        backdropFilter: "blur(0px)", // No blur until overlay reveals
      ...
      // PHASE 1: Animate the container to expand (NO darkening yet)
      mainTl
        .to(
          container,
          {
        ...
        // PHASE 2: Video LOCKED at full size, overlay and darkening reveal together
        .to(
          overlayEl,
          {
            clipPath: "inset(0% 0 0 0)",
            backdropFilter: `blur(${overlayBlur}px)`,
            background: "rgba(10,10,14,0.5)", // Add dark background when revealing
            ease: overlayEase,
          },
          "+=0.5" // Start after expansion completes
        )
        // Darken ONLY when overlay reveals (very subtle)
        .to(
          overlayDarkenEl,
          {
        ...
        .to(
          ...
          "-=0.6" // Overlap slightly with overlay reveal
        )
        .to(
          overlayContent,
          {
  ...
  return (
    <div
      ...
      style={{ ...cssVars, ...style }}
    >
      {/* Lamp animation (if provided) */}
      {lamp ? <div className="hsv-lamp">{lamp}</div> : null}
        ...
        <div className={`hsv-sticky ${sticky ? "is-sticky" : ""}`}>
          <div className="hsv-media" ref={containerRef}>
            ...
            <div className="hsv-overlay" ref={overlayRef}>
              ...
              <div
                className="hsv-overlay-content"
                ref={overlayContentRef}
                data-overlay-layout={overlay?.layout ?? "default"}
              >
      ...
      <style>{`
        ...
        /* Clean rectangular display for cards - no circular wrapping */
        .hsv-meta[data-has-card="true"] {
          padding: 0 !important;
        ...
        .hsv-meta[data-has-card="true"]::before {
        ...
        .hsv-overlay {
          position: absolute;
          inset: 0;
          background: transparent; /* No background until revealed */
        ...
        .hsv-overlay-content[data-overlay-layout="full-bleed"] {
          margin-top: 0;
          max-width: none;
