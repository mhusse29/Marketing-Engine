  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const cameraPositions = [
        { x: 0, y: 30, z: 300 },    // Section 0 - CREATE
        { x: 0, y: 40, z: -50 },     // Section 1 - AMPLIFY
        { x: 0, y: 50, z: -700 }       // Section 2 - ELEVATE
      ];
      ...
      <div className="scroll-sections">
        {[...Array(3)].map((_, i) => {
          ...
          const subtitles: { [key: number]: { line1: string; line2: string } } = {
            0: {
              line1: 'Where briefs become campaigns,',
              line2: 'powered by AI precision'
            },
            1: {
              line1: 'Cross-platform content generation,',
              line2: 'optimized for every audience'
            },
            2: {
              line1: 'From concept to conversion,',
              line2: 'your marketing engine awaits'
            }
          };
